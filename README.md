# `libcgal_julia_jll.jl` (v0.12.0+0)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl). The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/0e9d2fe7e1ec9c4da36ba01fee7ed8d63eab59d0/L/libcgal_julia/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/rgcv/libcgal-julia.git (revision: `d887f187eb44f6b4030710ebc776c79cd1b3e117`)
