# `libcgal_julia_jll.jl` (v0.15.0+0)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl). The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/8785615566927318926ec0a885998cd717196e9b/L/libcgal_julia/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/rgcv/libcgal-julia.git (revision: `64587dbe445f3c6f7bff5ffd67e367e4131c7300`)
