...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import libcgal_julia_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("e9ad47b2-a301-5fb7-a0bd-6eece649b37c"))
platforms = [Pkg.Artifacts.unpack_platform(e, "libcgal_julia", artifacts_toml) for e in artifacts["libcgal_julia"]]
...
if best_platform === nothing
    @debug("Unable to load libcgal_julia; unsupported platform $(triplet(platform_key_abi()))")
else
