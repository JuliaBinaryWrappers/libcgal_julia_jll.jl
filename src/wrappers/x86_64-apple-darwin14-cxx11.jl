...
export libcgal_julia_inexact, libcgal_julia_exact
...
const libcgal_julia_inexact_splitpath = ["lib", "libcgal_julia_inexact.dylib"]
...
const libcgal_julia_inexact = "@rpath/libcgal_julia_inexact.dylib"


# Relative path to `libcgal_julia_exact`
const libcgal_julia_exact_splitpath = ["lib", "libcgal_julia_exact.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libcgal_julia_exact = "@rpath/libcgal_julia_exact.dylib"
